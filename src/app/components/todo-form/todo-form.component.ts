...
import { apply, form, FormField, FormRoot, maxLength, minLength, required } from '@angular/forms/signals';
...
export class TodoFormComponent implements OnInit {
  ...
  formTree = form(this.formData, {
    title: apply(required(), minLength(2), maxLength(120)),
  });

  get titleField() {
    return this.formTree.fields.title;
  }
